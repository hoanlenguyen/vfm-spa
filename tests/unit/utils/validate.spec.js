...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/Stonehubvn/stonehub-vue-admin-template')).toBe(true)
    expect(validURL('http://github.com/Stonehub/stonehub-vue-admin-template')).toBe(true)
    expect(validURL('github.com/Stonehub/stonehub-vue-admin-template')).toBe(false)
  })
  it('validLowerCase', () => {
