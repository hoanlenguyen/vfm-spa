  ...
  <div class="card">
    <div class="card-header">
      <el-row type="flex" justify="space-between" align="middle">
        <h4 class="card-title">
          <span class="card-label">Fontawesome 5</span>
          <span
            class="card-sub-label"
          >Get vector icons and social logos on your website with Font Awesome, the web's most popular icon set and toolkit.</span>
        </h4>
        <div class="d-flex ml-4">
          ...
          >
            <s-icon icon="material-brush"></s-icon>
          </el-button>
          <el-button
            type="primary"
        ...
        <el-row :gutter="16">
          <template v-for="icon of category.icons">
            ...
            >
              ...
              >
                <s-icon :icon="style +' fa-' + icon"></s-icon>
                <span class="icon-name ml-4">{{ style +' fa-' + icon }}</span>
              </el-button>
            </el-col>
          </template>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    generateIconCode(symbol, style) {
      return `<s-icon icon="${style} fa-${symbol}" />`;
    },
