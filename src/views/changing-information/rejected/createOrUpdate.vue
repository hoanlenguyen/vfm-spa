        ...
        <el-form ref="model" :model="model" label-position="top">
          <el-row id="general" :gutter="16">
            ...
            <el-col :span="6">
              ...
              <!-- <el-form-item prop="changingInformationVideoCallUrl" v-if="model.isUnlimitedLevel">
                <template #label>{{ $t("Video call xác nhận thay đổi thông tin") }}</template>
                <uploadFile
                  class="uploadFile"
...
export default {
  ...
  methods: {
    ...
    getDetail(id) {
      this.isLoading = true;
      let approvalProcess = 300; //rejected
