      ...
      >
        ...
        <div class="m-2">
          <el-button
            ...
            title="Tải danh sách thay đổi thông tin"
            >{{ $t("Export excel") }}
          </el-button>
        </div>
        <div class="m-2">
    ...
    <div class="p-0 pb-5 card-body">
      ...
      >
        ...
        <el-table-column
          ...
          align="center"
          prop="requestChangeUserInfoTime"
          sortable
          width="170px"
        >
          <template slot-scope="scope">
  ...
  data() {
    return {
      ...
      filter: {
        ...
        filterKeyword: "",
        accountType: 10,
        accountFilterType: AccountFilterType.ApprovedChangingInformation,
        isNewFlowChangeInfo: null,
      },
      filterKeyword: "",
