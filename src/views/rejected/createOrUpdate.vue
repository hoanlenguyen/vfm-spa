          ...
          <el-row id="general" :gutter="16">
            ...
            <el-col :span="6">
              <el-form-item
                ...
                prop="rejectedByEmail"
              >
                <el-input
                  :disabled="true"
                  v-model="model.rejectedByEmail"
                  clearable
                />
              </el-form-item>
...
export default {
  ...
  watch: {
    ...
    //   v && this.fetchBankBranchList();
    //   !v && (this.listBankBranch = []);
    // },
  },
  created() {
