                ...
                <el-col :md="8" :sm="24">
                  <el-form-item
                    ...
                    :rules="[
                      {
                        required: true,
                        message: $t('Vui lòng nhập tên loại'),
                        trigger: 'blur',
                      },
                    ]"
                    prop="name"
                ...
                <el-col :md="8" :sm="24">
                  <el-form-item
                    ...
                    :rules="[
                      {
                        required: true,
                        message: $t('Vui lòng nhập mã chỉ số thị trường'),
                        trigger: 'blur',
                      },
                    ]"
                    prop="code"
...
<script>
import { createOrUpdate, getForEdit } from "@/api/stockIndexType";
...
export default {
  ...
  computed: {
    formTitle() {
      return this.$route.query.id ? "Chi tiết loại chỉ số thị trường ": "Tạo loại chỉ số thị trường";
    },
  },
  watch: {
