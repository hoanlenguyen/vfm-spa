  ...
  <div class="card">
    ...
    <div class="p-0 pb-5 card-body">
      ...
      >
        ...
        <el-table-column
          :label="$t('Huỷ/từ chối bởi')"
          align="center"
          prop="upgradeLevelRejectedByEmail"
          sortable="custom"
          width="200px"
        >
          <template slot-scope="scope">
            <span>{{ scope.row.upgradeLevelRejectedByEmail }}</span>
          </template>
        </el-table-column>
        <el-table-column
  ...
  data() {
    return {
      ...
      filter: {
        ...
        filterKeyword: "",
        accountType: 10,
        accountFilterType: AccountFilterType.RejectedUpgradeLevel,
      },
      filterKeyword: "",
