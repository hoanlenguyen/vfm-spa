    ...
    <div class="p-0 pb-5 card-body">
      ...
      >
        ...
        <el-table-column
          ...
          align="center"
          prop="contactTimeUpgradeLevel"
          sortable
          width="200px"
        >
          <template slot-scope="scope">
            <span>{{ getContactTime(scope.row.contactTimeUpgradeLevel) }}</span>
          </template>
        </el-table-column>
        <el-table-column
          :label="$t('Số Dskh')"
        ...
        <el-table-column
          ...
          align="center"
          prop="requestUpgradeLevelTime"
          sortable="custom"
          width="170px"
        >
          <template slot-scope="scope">
            <span>{{ scope.row.requestUpgradeLevelTime | dateTime }}</span>
          </template>
        </el-table-column>
        <el-table-column
          :label="$t('Tên đối tác')"
...
import { GenderTypes, AccountFilterType } from "@/utils/enums";
...
export default {
  ...
  data() {
    return {
      ...
      filter: {
        rowsPerPage: 10,
        sortBy: "requestUpgradeLevelTime",
        sortDirection: "desc",
        filterKeyword: "",
        accountType: 10,
        accountFilterType: AccountFilterType.PendingUpgradeLevel,
      },
      filterKeyword: "",
