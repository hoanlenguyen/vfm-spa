  ...
  <div class="createItemContainer">
      ...
      <template #title>
        <div class="dialogFullscreen__title">
          ...
          <el-button
            ...
            :loading="isSubmit"
            type="primary"
            @click="approveUpgradeUserLevel"
            >{{ $t("Xác nhận nâng cấp") }}</el-button
          >
          <el-button
            v-if="isAllowEdit"
            type="danger"
            @click="rejectUpgradeUserLevel"
            >{{ $t("Từ chối") }}
          </el-button>
        </div>
      </template>
          ...
          <el-row id="general" :gutter="16">
            ...
            <el-col :span="18">
              <el-row :gutter="16">
                ...
                <el-col :md="6" :sm="24">
                  <p>{{ $t("Thời gian liên lạc") }}</p>
                  <p class="mt-4">{{ getContactTime(model.contactTimeUpgradeLevel) }}</p>
                </el-col>
              </el-row>
              <el-row :gutter="16" class="mt-4">
                <!-- <el-col :md="6" :sm="24">
                  <el-form-item
                    prop="contractForUnlimitedLevelUrl"
                  >
                    <template #label>
            ...
            <el-col :span="6">
              <el-form-item :label="$t('Lý do từ chối tài khoản')">
                <el-input
                  v-model="model.rejectedReasonForUpgradeLevel"
                  type="textarea"
                  :rows="5"
                  clearable
                />
    ...
    >
      <el-form ref="ruleRejectedForm" :model="modelRejected">
        <div class="my-4">{{ $t("Lí do từ chối nâng cấp tài khoản") }}</div>
        <el-form-item
          :rules="[
            {
              whitespace: true,
          ...
          prop="rejectedReasonForUpgradeLevel"
        >
          <el-input
            v-model="modelRejected.rejectedReasonForUpgradeLevel"
...
export default {
  ...
  methods: {
    ...
    rejectUpgradeUserLevel() {
      this.modelRejected.rejectedReasonForUpgradeLevel =
        this.model.rejectedReasonForUpgradeLevel;
