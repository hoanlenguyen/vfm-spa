<template>
  <div class="card">
    ...
    <div class="card-toolbox d-flex flex-column flex-md-row justify-content-end align-items-stretch">
      <div
        class="d-flex flex-column flex-md-row align-items-stretch align-items-sm-center justify-content-end"
      >
        <div class="m-2">
          <el-input
            ...
            class="w-abs-400"
            :placeholder="$t('Tìm theo tên, số điện thoại, địa chỉ email, số DKSH')"
            clearable
      ...
      >
       <el-table-column
        ...
        >
          <template slot-scope="scope">
            <div class="w-max-100 text-ellipsis">
              <span :title="scope.row.approveUser">{{
  ...
  data() {
    return {
      ...
      filter: {
        ...
        sortDirection: "desc",
        filterKeyword: "",
        consentLetterStatus: ConsentLetterStatus.Rejected
      },
      filterKeyword: '',
