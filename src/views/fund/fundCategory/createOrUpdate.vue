          ...
          <el-row id="general" :gutter="16">
            ...
            <el-col :sm="24">
              <el-row :gutter="16">
                <el-col :md="3" :sm="24">
                  <el-form-item
                    :label="`${$t('Ảnh đại diện')} (kích thước: 96 x 146)`"
                    prop="avatarUrl"
                  >
                    <UploadCroppedImage
                      ...
                      :size-limit="2"
                      :folderName="storageFolder.fundCategory"
...
<script>
import { createOrUpdate, getForEdit } from "@/api/fundCategory";
...
export default {
  ...
  computed: {
    formTitle() {
      return this.$route.query.id ? "Chi tiết loại quỹ" : "Tạo loại quỹ";
    },
  },
  watch: {
