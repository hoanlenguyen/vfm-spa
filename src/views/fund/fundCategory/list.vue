    ...
    <div class="card-header">
      ...
      >
        <h3 class="mb-3 card-title">
          <span class="card-label">{{ $t("Danh mục quỹ") }}</span>
        </h3>
        <div
...
<script>
import { fetchList, deleteItem } from "@/api/fundCategory";
import createOrUpdate from "./createOrUpdate";
import { FundCategoryTypes } from "@/utils/enums";
import { Fund } from "@/utils/app-permission.js";

export default {
  name: "FundCategoryList",
